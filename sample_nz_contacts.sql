-- Sample New Zealand Contacts with Multiple Phones and Addresses
-- Generated for DaySave contact management testing

-- Note: Replace 'YOUR_USER_ID' with an actual user ID from your users table
-- Example: UPDATE these with a real user UUID like 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'
...
INSERT INTO contacts (
  ...
  UUID(), 'YOUR_USER_ID', 'Sarah Mitchell',
  JSON_ARRAY(
...
INSERT INTO contacts (
  ...
  UUID(), 'YOUR_USER_ID', 'James Thompson',
  JSON_ARRAY(
...
INSERT INTO contacts (
  ...
  UUID(), 'YOUR_USER_ID', 'Michael Brown',
  JSON_ARRAY(
...
INSERT INTO contacts (
  ...
  UUID(), 'YOUR_USER_ID', 'David Taylor',
  JSON_ARRAY(
...
INSERT INTO contacts (
  ...
  UUID(), 'YOUR_USER_ID', 'Rachel Green',
  JSON_ARRAY(
...
INSERT INTO contacts (
  ...
  UUID(), 'YOUR_USER_ID', 'Andrew Smith',
  JSON_ARRAY(
...
INSERT INTO contacts (
  ...
  UUID(), 'YOUR_USER_ID', 'Sophie Williams',
  JSON_ARRAY(
...
INSERT INTO contacts (
  ...
  UUID(), 'YOUR_USER_ID', 'Mark Johnson',
  JSON_ARRAY(
...
-- 1. Replace 'YOUR_USER_ID' with an actual user UUID from your users table
-- 2. Run these INSERT statements in your MySQL database
-- 3. Verify the JSON structure matches your contacts table schema
-- 4. Adjust phone number formats if needed (+64 is New Zealand country code)

-- Example query to update user_id for all these contacts:
-- UPDATE contacts SET user_id = 'your-actual-user-uuid-here' WHERE user_id = 'YOUR_USER_ID'; 